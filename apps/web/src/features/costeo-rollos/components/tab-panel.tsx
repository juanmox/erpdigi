            ...
            <div className="mb-2 flex items-center justify-between">
              ...
              <span
                className={cn(
                  ...
                  item.montaje ? 'bg-accent-brand-soft text-accent-brand-strong' : 'bg-black/[0.04] text-ink-faint dark:bg-white/[0.06]',
                )}
              >
            ...
            {item.montaje ? (
              <div className="space-y-2.5">
                ...
                <div className="text-xs text-ink-muted">
                  Consumo: <span className="font-medium text-ink">{item.montaje.consumoAcumulado.toFixed(2)} yd</span>
